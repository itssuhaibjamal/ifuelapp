...
// check if collection that we are fetching if its empty excute the else statement
   ...
   docSnap.forEach(doc => {
      ...
      if(doc.data().comp_associated_email == companyemail){
        ...
        <td class='d-flex'><a href="view-single-post.html?view=${doc.id}" class='btn btn-primary'>View</a>&numsp;<a href='update-post.html?update=${doc.id}' class='btn btn-success'>Update</a> &numsp;<a href='view_employee.html?delete=${doc.id}' class='btn btn-danger'>Delete</a></td>
        </tr>
